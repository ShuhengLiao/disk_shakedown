...
comp2prop = get_composition2property_from_csv('../material/disk_24_properties.csv')
...
for omega in [1800,2100,2400,2700,3000,3300]:
	for T_load in [200,250,300,350,400]:
		sol_folder = './sols_{}_{}'.format(omega,T_load)
